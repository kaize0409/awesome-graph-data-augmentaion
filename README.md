## Graph Data Augmentation(GraphDA)
...
|PTDNet|[[WSDM 2021]] Learning to drop: Robust graph neural network via topological denoising [[Code]](https://github.com/flyingdoog/PTDNet)|
